    ...
    <form action="{{ route('usuarios.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div>
                ...
                <input name="email" value="{{ old('email') }}" class="w-full border rounded p-2" type="email" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input name="password_confirmation" class="w-full border rounded p-2" type="password" required>
            </div>
            <div>
