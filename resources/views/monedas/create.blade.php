        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Nueva Moneda</h3>
                    <p class="mt-1 text-sm text-gray-600">
                        Ingrese los datos de la nueva moneda.
                    </p>
                </div>
            </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <select id="activa" name="activa" 
                                        ...
                                        <option value="1" {{ old('activa') ? 'selected' : '' }}>Activa</option>
                                        <option value="0" {{ !old('activa') ? 'selected' : '' }}>Inactiva</option>
                                    </select>
                                    @error('activa')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
